/**
 ...
 Class Description:: This class is for see all drawing image.
 
 Version:: 1.0
 
 Author:: Nikunj Modi
 
 Created Date:: 28/09/12.
 
 Modified Date:: 28/09/12.
 */
...
- (void)removeItemAtIndex:(NSInteger)index animated:(BOOL)animated
{
    ...
    {
        CGPoint center1 = CGPointMake(0,150);
        CGPoint center = CGPointMake(0,300);
        UIBezierPath *movePath = [UIBezierPath bezierPath];
        [movePath moveToPoint:center1];
        [movePath addQuadCurveToPoint:center
                         controlPoint:CGPointMake(center.x, center1.y)];
        ...
        [itemView.layer addAnimation:animGroup forKey:nil];
